...
// if(color == 2, {
// knobColor = Color.new255(130, 130, 200);
// knobColorMore = Color.new255(180, 130, 140);
// });
// if(color == 3, {
// knobColor = Color.new255(180, 180, 0);
// knobColorMore = Color.new255(0, 238, 238);
// });
// if(color == 4, {
// knobColor = Color.new255(46, 150, 87);
// knobColorMore = Color.new255(46, 87, 200);
// });
...
dropDownColor = Color.fromHexString("#B7CECE");
...
popObj1.action = { arg menu;
	...
	('OBj1 is: ' ++ obj1.description).postln })};
...
popObj2.action = { arg menu;
	...
	('obj2 is: ' ++ obj2.description).postln })};
...
popObj3.action = { arg menu;
	...
	('obj3 is: ' ++ obj3.description).postln })};
...
popObj4.action = { arg menu;
	...
	('obj4 is: ' ++ obj4.description).postln })};
...
popObj5.action = { arg menu;
	...
	('obj5 is: ' ++ obj5.description).postln })};
...
popObj6.action = { arg menu;
	...
	('obj6 is: ' ++ obj6.description).postln })};
...
popObj7.action = { arg menu;
	...
	('obj7 is: ' ++ obj7.description).postln })};
...
popObj8.action = { arg menu;
	...
	('obj8 is: ' ++ obj8.description).postln })};
...
updateObjects = {
	...
	if(obj1IsPlaying > 0,
 	...
 	if(obj4IsPlaying > 0,
 		{ 'update obj 4'.postln; obj4.update });
...
buttonObj1 = Button(window, Rect(xButton, yButton, buttonWidth, 30))
    ...
    .action_({|view|  if (view.value ==1)
						{if(obj1.notNil, {'trying to play'.postln; obj1.duration = nbDuration.value; obj1.duration.postln; obj1.play; obj1IsPlaying = 1;})}
